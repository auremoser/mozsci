...
* made little [tracking repo](https://github.com/auremoser/mozsci) with tasks
...
* met with abby to talk about projects, collaborate, issue trackers
...
* gave talk at WLIA
* study group call 
* worked on [newsletter round up](https://public.etherpad-mozilla.org/p/sciencelab-week-in-review-monthly-highlights) with Arliss
* write up wrap up blog for fellows
* content calendar for MSL
* correspondence for various post-wow issues
* posted pre-blog on fellows
...
* meeting with KT [notes](https://public.etherpad-mozilla.org/p/1_1_Aurelia)
* msl staff checkin
...
* welcomed some new study group leads [1](https://github.com/drashti4/studyGroup/commit/20e779a13c64bc373bd3e458c8d00b520f6d29a8) + [2](https://github.com/colleenboodleman/Womens-GeoViz-StudyGroup/issues/3), [3](https://github.com/akshit13/studyGroup/issues/1), [4](https://github.com/DataScienceHobart/studyGroup/issues/3)
...
* put together study group stats for KT
* posted [joey's fellowship blog](https://science.mozilla.org/blog/ff-joey)
...
* study group onboarding meeting
...
* david's [farewell](https://public.etherpad-mozilla.org/p/ttfn-david)
...
* setup [study group call issue](https://github.com/mozillascience/plan/issues/88)
  ...
  * email study group list with reminder
  * remind Joey + Jeff
  * tweeted about it
...
* application things! announced and shared with team
...
* made mozfest presentation for [abby's mentees](https://docs.google.com/a/mozilla.com/presentation/d/1oVx2USeiDbH3Kz1pe_6FnL9KZYa7iRZO78aSdNNPTic/edit?usp=sharing)
